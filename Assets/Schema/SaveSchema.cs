...
public sealed class GameDataWhatever : Table {
  ...
  public ArraySegment<byte>? GetInventoryBytes() { return __vector_as_arraysegment(12); }
  public Color Color { get { int o = __offset(14); return o != 0 ? (Color)bb.GetSbyte(o + bb_pos) : Color.Blue; } }
  public WeaponClassesOrWhatever WeaponType { get { int o = __offset(16); return o != 0 ? (WeaponClassesOrWhatever)bb.Get(o + bb_pos) : WeaponClassesOrWhatever.NONE; } }
  ...
  public static void FinishGameDataWhateverBuffer(FlatBufferBuilder builder, Offset<GameDataWhatever> offset) { builder.Finish(offset.Value); }
};
...
public sealed class Rocket : Table {
  public static Rocket GetRootAsRocket(ByteBuffer _bb) { return GetRootAsRocket(_bb, new Rocket()); }
  public static Rocket GetRootAsRocket(ByteBuffer _bb, Rocket obj) { return (obj.__init(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public Rocket __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }

  public int Damage { get { int o = __offset(4); return o != 0 ? bb.GetInt(o + bb_pos) : (int)600; } }

  public static Offset<Rocket> CreateRocket(FlatBufferBuilder builder,
      int damage = 600) {
    builder.StartObject(1);
    Rocket.AddDamage(builder, damage);
    return Rocket.EndRocket(builder);
  }

  public static void StartRocket(FlatBufferBuilder builder) { builder.StartObject(1); }
  public static void AddDamage(FlatBufferBuilder builder, int damage) { builder.AddInt(0, damage, 600); }
  public static Offset<Rocket> EndRocket(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<Rocket>(o);
  }
};
